...
Quickly add income and expenses with descriptions and amounts.

### Graphical User Interface (GUI)

A clean design built with tkinter, including background image support and custom styling.

### Persistent History

Automatic data saving using a local database (SQLite).
